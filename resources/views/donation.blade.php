...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="title" content="Donasi | World Generation Gathering - Global UPR">
        <meta name="description" content="Bantuan Anda akan membantu konfrensi ini dapat berjalan dengan baik!">
        <title>Donasi | World Generation Gathering - Global UPR</title>
